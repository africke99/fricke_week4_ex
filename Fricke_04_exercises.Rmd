...
```{r}
#open street map zoom to correct, copy numbers, put into get stamen, then write in numbers
...
mac<-data.frame(long=44.9379,lat=-93.1691)

ggmap(twincities)+
  geom_point(data=mac,aes(long,lat),colour="red",size=90)
...
ADD TITLE W CAPTION, MAKE CONCLUSION 
...
kkechely@macalester.edu
clopez2@macalester.edu
skelly1@macalester.edu
yfang@macalester.edu
elugthar@macalester.edu
jcasilla@macalester.edu
612 239 0235
9733889155
